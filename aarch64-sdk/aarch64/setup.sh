...
SetupToolchain() {
  ...
  [[ ! -f $CURR_DIR/gcc-aarch64-linux.tar.xz ]] && wget https://armkeil.blob.core.windows.net/developer/Files/downloads/gnu/11.2-2022.02/binrel/gcc-arm-11.2-2022.02-x86_64-aarch64-none-linux-gnu.tar.xz -O $CURR_DIR/gcc-aarch64-linux.tar.xz
